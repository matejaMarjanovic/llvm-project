...
for.body.lr.ph:                                   ; preds = %entry
  ...
  ; CHECK-NEXT: %0 = load
  ; CHECK-NEXT: call void @llvm.dbg.value(metadata i64 %0, metadata !25, metadata !DIExpression(), metadata undef, metadata !DIExpression()), !dbg !
  ; CHECK-NEXT: call void @llvm.dbg.value(metadata i64 %0, metadata !26, metadata !DIExpression(DW_OP_constu, 4096, DW_OP_minus, DW_OP_stack_value), metadata undef, metadata !DIExpression()), !dbg !
...
for.body:                                         ; preds = %for.body.lr.ph, %for.body
  ...
  ; CHECK: call void @llvm.dbg.value(metadata i64 %offset.010, metadata !26, metadata !DIExpression(DW_OP_constu, 4096, DW_OP_minus, DW_OP_stack_value), metadata undef, metadata !DIExpression()), !dbg !
