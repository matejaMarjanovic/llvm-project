...
for.body:                                         ; preds = %entry, %for.body
  ...
  ; CHECK: call void @llvm.dbg.value(metadata i32 1, metadata !12, metadata !DIExpression(), metadata undef, metadata !DIExpression()), !dbg !15
  ; CHECK: call void @llvm.dbg.value(metadata i32 4, metadata !12, metadata !DIExpression(), metadata undef, metadata !DIExpression()), !dbg !15
  ; CHECK: call void @llvm.dbg.value(metadata i32 16, metadata !12, metadata !DIExpression(), metadata undef, metadata !DIExpression()), !dbg !15
  ; CHECK: call void @llvm.dbg.value(metadata i32 64, metadata !12, metadata !DIExpression(), metadata undef, metadata !DIExpression()), !dbg !15
